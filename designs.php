            ...
            <div class="row px-2">
              <div class="col-md-4 px-2">
                <div class="mb-4 price-card price-card1 p-lg-4 p-md-3 p-4">
                  <div class="card-header p-0 card-heading">
                    <h4 class="mb-4"> Desgins </h4>
                  </div>
                  <div class="card-body p-0">
                    <div id="cf">
                      <img class="bottom" src="image/city3.jpg" />
                      <img class="top" src="image/city.jpg" />
                    </div>
                    <div class="mt-4">
                      <a href="signup.html" class="btn btn-lg btn-outline-primary btn-style border-btn"> Select </a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4 px-2">
                ...
                <div class="mb-4 price-card price-card2 p-lg-4 p-md-3 p-4 recomemded-price">
                  <div class="card-header p-0 card-heading">
                    <h4 class="mb-4">My Designs <span class="label label-popular">Popular</span></h4>
                  </div>
                  <div class="card-body p-0">
                  <div id="cf">
                      <img class="bottom" src="image/slider_1.jpg" />
                      <img class="top" src="image/city3.jpg" />
                    </div>
                    <div class="mt-4">
                      <a href="#" class="btn btn-lg btn-primary btn-style"> Check </a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4 px-2">
                ...
                <div class="mb-4 price-card price-card3 p-lg-4 p-md-3 p-4">
                  <div class="card-header p-0 card-heading">
                    <h4 class="mb-4">Colletions</h4>
                  </div>
                  <div class="card-body p-0">
                    <div id="cf">
                      <img class="bottom" src="image/img_5.jpg" />
                      <img class="top" src="image/hero_1.jpg" />
                    </div>
                    <div class="mt-4">
                      <a href="#" class="btn btn-lg btn-outline-primary btn-style border-btn">Contact</a>
                    </div>
                  </div>
                </div>
                </div>
