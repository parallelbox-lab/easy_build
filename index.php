							...
							<div class="signin-form profile admin">
								<img src="image/logo.png" height="80px" width="200px">
									...
									<div class="login-form">
										<input type="text" name="name" id="first_name"  placeholder="Enter Firstname" required="">
										<input type="text" name="name" id="last_name"  placeholder="Enter Lastname" required="">
